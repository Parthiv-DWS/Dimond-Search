...
const SwitcherMode: FC = () => {
  ...
  return (
    <>
      <label
        className="flex cursor-pointer select-none items-center rounded-lg px-3"
        aria-label="mode-checkbox1"
      >
        <input
          type="checkbox"
          checked={isDarkMode}
          ...
          className="sr-only"
          aria-label="mode-checkbox"
        />
        <div
          className={`shadow-card flex items-center justify-center rounded-md shadow-sm border shadow-slate-400${
        ...
        >
          {isDarkMode ? (
            ...
            <span
              className={`flex h-9 w-9 items-center justify-center rounded text-black`}
            >
              <svg
                width="16"
                height="16"
